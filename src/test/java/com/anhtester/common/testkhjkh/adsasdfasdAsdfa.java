...
public class adsasdfasdAsdfa {

    private WebDriver driver;
    private String className = "adsasdfasdAsdfa";
    private String subid = "KN-121";

    // Constructor to initialize WebDriver and set className and subid
    public adsasdfasdAsdfa(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        adsasdfasdAsdfa test = new adsasdfasdAsdfa(driver);
        test.runTest();
    }
}
