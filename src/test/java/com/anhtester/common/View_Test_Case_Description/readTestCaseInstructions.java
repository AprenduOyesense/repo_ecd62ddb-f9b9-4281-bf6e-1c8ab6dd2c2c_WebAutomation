...
public class readTestCaseInstructions {

    private WebDriver driver;
    private String className = "readTestCaseInstructions";
    private String subid = "KN-102";

    // Constructor to initialize WebDriver and set className and subid
    public readTestCaseInstructions(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        readTestCaseInstructions test = new readTestCaseInstructions(driver);
        test.runTest();
    }
}
