...
public class trackAssociatedProblems {

    private WebDriver driver;
    private String className = "trackAssociatedProblems";
    private String subid = "KN-105";

    // Constructor to initialize WebDriver and set className and subid
    public trackAssociatedProblems(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        trackAssociatedProblems test = new trackAssociatedProblems(driver);
        test.runTest();
    }
}
