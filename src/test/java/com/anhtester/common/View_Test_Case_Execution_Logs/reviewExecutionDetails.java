...
public class reviewExecutionDetails {

    private WebDriver driver;
    private String className = "reviewExecutionDetails";
    private String subid = "KN-104";

    // Constructor to initialize WebDriver and set className and subid
    public reviewExecutionDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        reviewExecutionDetails test = new reviewExecutionDetails(driver);
        test.runTest();
    }
}
