...
public class assignOwnership {
    ...
    private String className = "assignOwnership";
    private String subid = "KN-106";

    // Constructor to initialize WebDriver and set className and subid
    public assignOwnership(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        assignOwnership test = new assignOwnership(driver);
        test.runTest();
    }
}
