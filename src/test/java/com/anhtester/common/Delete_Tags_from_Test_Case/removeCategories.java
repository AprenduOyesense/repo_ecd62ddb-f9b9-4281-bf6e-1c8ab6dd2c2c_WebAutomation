...
public class removeCategories {
    ...
    private String className = "removeCategories";
    private String subid = "KN-118";

    // Constructor to initialize WebDriver and set className and subid
    public removeCategories(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeCategories test = new removeCategories(driver);
        test.runTest();
    }
}
