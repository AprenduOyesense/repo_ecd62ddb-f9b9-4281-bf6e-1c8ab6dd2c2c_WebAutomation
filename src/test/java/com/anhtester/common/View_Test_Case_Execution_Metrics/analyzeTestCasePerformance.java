...
public class analyzeTestCasePerformance {

    private WebDriver driver;
    private String className = "analyzeTestCasePerformance";
    private String subid = "KN-101";

    // Constructor to initialize WebDriver and set className and subid
    public analyzeTestCasePerformance(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        analyzeTestCasePerformance test = new analyzeTestCasePerformance(driver);
        test.runTest();
    }
}
